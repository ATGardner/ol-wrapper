...
describe('Maps', () => {
  ...
  it('uses the right target element', () => {
    const target = 'map', targetElement = document.createElement('div');
  ...
  it('creates view', () => {
    const olClass = 'View', actual = createOlObject({
        olClass
      });
      ...
      layers: [
        {
          ...
          source: {
            ...
            attributions: ['Source: Copyright:© 2013 National Geographic Society, i-cubed.']
          }
        }
      ]
    },
